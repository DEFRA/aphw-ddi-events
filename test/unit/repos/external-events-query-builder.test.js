...
describe('ExternalEventsQueryBuilder', () => {
  ...
  describe('constructSearchFilter', () => {
    test('returns correct query when dates supplied', () => {
      ...
      expect(query).toBe('PartitionKey eq \'search\' and ((RowKey gt \'john|2024-05-05\' and RowKey lt \'john|2024-10-10\') or (RowKey gt \'smith|2024-05-05\' and RowKey lt \'smith|2024-10-10\'))')
    })

    test('returns correct query when no dates', () => {
      const query = constructSearchFilter(['john', 'smith'])
      expect(query).toBe('PartitionKey eq \'search\' and ((RowKey gt \'john|\' and RowKey lt \'john|\') or (RowKey gt \'smith|\' and RowKey lt \'smith|\'))')
    })
  })
