...
const enforcementJwt = () => {
  ...
  const options = {
    expiresIn: '1h',
    algorithm: 'RS256',
    audience: 'aphw-ddi-events',
    issuer: 'aphw-ddi-enforcement',
    keyid: 'aphw-ddi-enforcement'
  }

  const token = jwt.sign({
    username: 'enforcement.user@test.com',
    displayname: 'enforcement.user@test.com',
  ...
  return {
    headers: {
      'ddi-username': 'enforcement.user@test.com',
      'ddi-displayname': 'enforcement.user@test.com',
